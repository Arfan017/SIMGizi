...
$q_terkirim = mysqli_query($conn, "SELECT COUNT(*) AS terkirim FROM tb_distribusi WHERE status_pengiriman = '1'");
$terkirim = mysqli_fetch_assoc($q_terkirim)['terkirim'];

// Jumlah belum terkirim (status = 0)
$q_belum_terkirim = mysqli_query($conn, "SELECT COUNT(*) AS belum FROM tb_distribusi WHERE status_pengiriman = '0'");
                                            ...
                                            <div class="col-md-4 col-6">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-3">
                                                        ...
                                                        <h5 class="mb-0"><?php echo $terkirim; ?></h5>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 col-6">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-3">
                                                        ...
                                                        <h5 class="mb-0"><?php echo $total_diterima; ?></h5>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 col-6">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-3">
                                                        <p class="mb-0">Belum Dikirim</p>
                                                        <h5 class="mb-0"><?php echo $belum_terkirim; ?></h5>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
